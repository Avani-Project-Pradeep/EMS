...
<<<<<<< HEAD
      ...
      <span style="color:red">
        ...
        if (strlen($comp_name) > 50) //MAX LENGHTH SHOULD BE 50
        {
          ...
          echo "*Max Limit of company name is 50 characters ";
        }
        ...
        if ($containsDigit) {
          ...
          $error1++;
          echo "*Company name should not contain numeric value!!";
        }
  ...
  if(isset($_POST['er_register']))
{
  ...
  VALUES('{$er_phone}','{$city}','{$state}','{$email}')";
        ...
        if (($query_er1) && ($query_er2) && ($query_er3)) {
              ...
              echo"<a style=color:green;font-size:100px; href='er_register_confirm.php?email=$email'>Click to Continue</a></h1>";
