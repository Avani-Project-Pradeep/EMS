  ...
  <form action="edit_form.php" method="post" >
    ...
    <label>Designation</label>
      ...
      &nbsp
			...
			<input type="text" name="er_comp_name" value="<?php echo $er_company ?>" style="font-size: 18px;" size="15" />
			<label>
    ...
    <div class="form-group">
     	...
     	<label> Date of Joining: </label>
					...
					<input type="text" name="er_work_exp" style="font-size: 20px;" value="<?php echo $er_work ?>" size="10" />
					<i class="fa fa-briefcase" style="font-size:24px"></i>

				
          <br> <br>
        <label>Skills</label>
					<input type='textarea' style="font-size: 20px;" name="er_skills" value="<?php echo $er_skill ?>" size='40'>
    <br><br>
    
      <label>Bank Account Details</label>
					<input type='textarea' style="font-size: 20px;" name="er_bank_account" value="<?php echo $er_bank ?>" size='40'>
